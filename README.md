...
- [4. Phase](#4-phase)	
	...
	+ [Opportunitätskosten für Umweltservices](#opportunitätskosten-für-umweltservices)
	+ [Grundsteuer in Tunja](#grundsteuer-in-tunja)
	+ [R matrix workshop](#r-matrix-workshop)
	+ [Interkulturelle Praktiken in der Bildungseinbeziehung in Tunja](#interkulturelle-praktiken-in-der-bildungseinbeziehung-in-tunja)
	+ [Statistikgeschichte in Boyacá](#statistikgeschichte-in-boyacá)
	+ [Marktschätzung Festlegung von Preisen für das Theater Suárez in Tunja](#marktschätzung-festlegung-von-preisen-für-das-theater-suárez-in-tunja)
	+ [Beratung für den Master in Bildung](#beratung-für-den-master-in-bildung)
...
Dieses Projekt erlangte so viel Bedeutung, dass es in einer der wichtigsten Zeitschriften Kolumbiens veröffentlicht wurde ([`Klicke auf den Artikel`](http://www.scielo.org.co/scielo.php?pid=S0120-25962022000200011&script=sci_arttext))
...
Die Ergebnisse des Projekts dienen als wertvolle Grundlage für die Entwicklung von öffentlichen Politiken in Kolumbien, da große Datenmengen von Social-Media-Nutzern verwendet werden, die ihre Zustimmung oder Ablehnung zum Tourismus zum Ausdruck bringen. Dieses Projekt war von großer Bedeutung und wurde in einem Kapitel dieses Buches aufgenommen ([`Klicke auf den Artikel`](https://books.google.es/books?hl=es&lr=&id=2tpDEAAAQBAJ&oi=fnd&pg=PT7&ots=jYyLG_utmi&sig=OeZ5CMawDe1yJFEGnS_-seOh_Q0#v=onepage&q&f=false)).
...
Dieses Projekt besteht darin, die Wahrnehmung der Wirtschaft über das soziale Netzwerk Twitter und die wirtschaftlichen Prognosen für Lateinamerika und die Karibik während der Corona-Pandemie zu analysieren ([`Klicke auf den Code`](https://github.com/JuanCely999/Proyectos/tree/main/R_code/art_econ)). Es wurde Web-Scraping in der Software R für 19 Länder durchgeführt. Nach Extraktion der Informationen wurde eine textuelle und sentimentale Analyse durchgeführt. Es wurde festgestellt, dass die Twitter-Nutzer während Krisenzeiten ihre negativen Reaktionen erhöhen, was mit dem wirtschaftlichen Verhalten in jedem Land verbunden ist ([`Klicke auf den Artikel`](https://www.researchgate.net/publication/370943773_Percepcion_de_la_economia_de_America_Latina_y_el_Caribe_por_COVID-19_un_analisis_de_sentimientos_en_Twitter)).

<!--   Este proyecto consiste en analizar la percepcion de la economia desde la red social Twitter y las proyecciones economicas de America Latina y el Caribe durante Corona. Se realizo Web Scrapping en el software R para 19 paises, al extraer la informacion se realiza analisis textual y de sentimientos. Se encuentra que la población en Twitter en periodo de crisis incrementan sus reacciones negativas, asociado al comportamiento de la economia en cada pais.
